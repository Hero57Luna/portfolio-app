...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Rahadian Adikusuma Portfolio">
        <meta name="author" content="Rahadian Adikusuma">

        <title>Rahadian Adikusuma</title>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                ...
                <a href="#section_1" class="navbar-brand mx-auto mx-lg-0">Rahadian Adikusuma</a>
                        ...
                        <div class="col-lg-7 col-12">
                            <div class="hero-text">
                                <div class="hero-title-wrap d-flex align-items-center mb-4">
                                    <img src="images/me.jpg" class="avatar-image avatar-image-large img-fluid" alt="">
                                    <h1 class="hero-title ms-3 mb-0">Hello there!</h1>
                                </div>
                                <h2 class="mb-4">Let's take a tour on my portfolio!</h2>
                                <p class="mb-4"><a class="custom-btn btn custom-link" href="#section_2">Yes, please</a></p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-6 col-12 mt-5 mt-lg-0">
                            <div class="about-thumb">
                                ...
                                <div class="section-title-wrap d-flex justify-content-end align-items-center mb-4">
                                    <h2 class="text-white me-4 mb-0">Who am I</h2>

                                    <img src="images/me.jpg" class="avatar-image img-fluid" alt="">
                                </div>

                                <h3 class="pt-2 mb-3">a little bit about me</h3>

                                <p>
                                    My name is Bagas and I am 24 years old. I've been working as a programmer at Arkana Teknologi Indonesia for about a year now. 
                                    Also currently I am working as a part-time coding instructor at Timedoor Academy
                                </p>

                                <p>
                                    I was graduated from Polytechnic State of Malang, with a degree for applied computer science. After graduated on August 2021, I immediately got a job offer
                                    from Arkana Teknologi Indonesia and this is where I learned so much about programming in the real world
                                </p>
                            ...
                            <div class="profile-thumb">
                                ...
                                <div class="profile-body">
                                    <p>
                                        ...
                                        <span>Rahadian Bagaskara Adikusuma</span>
                                    </p>
                                    ...
                                    <p>
                                        <span class="profile-small-title">Phone</span> 
                                         <span><a href="tel: 305-240-9671">822-308-42350</a></span>
                                    </p>

                                    <p>
                                        <span class="profile-small-title">Email</span> 
                                        <span><a href="mailto:hello@josh.design">rahadian_98@yahoo.co.id</a></span>
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row pt-lg-5">
                                <div class="col-lg-6 col-12">
                                    <div class="services-thumb">
                                        <div class="d-flex flex-wrap align-items-center border-bottom mb-4 pb-3">
                                            ...
                                            <div class="ms-auto">
                                                <img src="images/laravel-logo.png" alt="..."  style="width:50px;height:50px;">
                                            </div>
                                        </div>

                                        <p>API and web development using Laravel framework</p>

                                        <a href="#section_4" class="custom-btn custom-border-btn btn mt-3">Discover More</a>
                                ...
                                <div class="col-lg-6 col-12 ">
                                    <div class="services-thumb services-thumb-up mb-3">
                                        <div class="d-flex flex-wrap align-items-center border-bottom mb-4 pb-3">
                                            <h3 class="mb-0">React Native</h3>

                                            <div class="ms-auto">
                                                <img src="images/react-native-logo.png" alt="..."  style="width:58px;height:50px;">
                                            </div>
                                        </div>

                                        <p>Mobile app development using React Native framework</p>
                                ...
                                <div class="col-lg-6 col-12">
                                    <div class="services-thumb">
                                        <div class="d-flex flex-wrap align-items-center border-bottom mb-4 pb-3">
                                            ...
                                            <div class="ms-auto">
                                                <img src="images/python-logo.png" alt="..."  style="width:50px;height:50px;">
                                            </div>
                                        </div>

                                        <p>API development and data scraping using Python</p>

                                        <a href="#" class="custom-btn custom-border-btn btn mt-3">Discover More</a>

                                        <div class="services-icon-wrap d-flex justify-content-center align-items-center">
                                            <i class="services-icon bi-graph-up"></i>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-12">
                                    <div class="services-thumb services-thumb-up">
                                        <div class="d-flex flex-wrap align-items-center border-bottom mb-4 pb-3">
                                            <h3 class="mb-0">Yii2</h3>

                                            <div class="ms-auto">
                                                <img src="images/yii2-logo.png" alt="..."  style="width:40px;height:50px;">
                                            </div>
                                        </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="projects-thumb">
                                <div class="projects-info">
                                    ...
                                    <h3 class="projects-title"><a href="https://fambus-admin.herokuapp.com/" target="_blank">Dashboard</a></h3>
                                </div>

                                <a href="images/fambus-admin.png" class="popup-image">
                                    <img src="images/fambus-admin-cropped.png" class="projects-image img-fluid" alt="">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="projects-thumb">
                                <div class="projects-info">
                                    <small class="projects-tag">React native</small>

                                    <h3 class="projects-title"><a href="https://play.google.com/store/apps/details?id=id.ac.uc.fbc.app&hl=en&gl=US" target="_blank">Fambus App</a></h3>
                                </div>

                                <a href="images/uc-fambus.png" class="popup-image">
                                    <img src="images/uc-fambus-cropped.png" class="projects-image img-fluid" alt="">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-6 col-12 pe-lg-0">
                                <div class="contact-info contact-info-border-start d-flex flex-column">
                                    <strong class="site-footer-title d-block mb-3">Useful Links</strong>

                                    <ul class="footer-menu">
                                        <li class="footer-menu-item"><a href="#" class="footer-menu-link">My CV</a></li>
                            ...
                            <div class="col-lg-3 col-md-6 col-12 ps-lg-0">
                                <div class="contact-info d-flex flex-column">
                                    ...
                                    <p>
                                        <a href="mailto:rahadian_98@yahoo.co.id">
                                ...
                                <form action="#" method="get" class="custom-form contact-form" role="form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 col-12">
                                            <div class="form-floating">
                                                <textarea class="form-control" id="message" name="message" placeholder="Hey! I would like to offer you a job..." required=""></textarea>
